				...
				<div class="pricing-box-alt">
					<div class="pricing-content">
						<table border="0" align="center">
							<tr>
								<td><p align="align"><h5>商品購買並びに決済が完了しました。</h5></p></td>
							</tr>
							<tr>
								<td><p align="align"><h5>詳細内訳はﾏｲﾍﾟｰｼﾞで確認可能です。利用してくださってありがとうございます。</h5></p></td>
							</tr>
							<tr>
								<td><p align="align"><a href="../main/WebMainServlet?command=main_page" class="btn btn-medium btn-theme" >確認</a></p></td>
							</tr>
