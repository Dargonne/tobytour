...
<style>
	...
	#tableline {border-top:1px solid  #CCCCCC; border-bottom:1px solid  #CCCCCC;
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">旅行商品</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
						...
						<div class="col-lg-12">
							...
							<c:forEach var ="product" items ="${productList}">
								...
								<div class="box-gray aligncenter">
									<div class="icon">
										<p align="center"><img src="${filePath}${product.productimage }" width="300" height="150"/></p>
									</div>
									<table border="0" align="center">
									<tr>
										<td id="line"><p align="left"><b>商品名 : ${product.productname}</b></p></td>
	 								</tr>
	 								<tr>
	 									<td  id="line"><p align="left"><b>商品説明 : ${product.productstatement }</b></p></td> 						
	 								</tr>
	 								<tr>
	 									<td  id="line"><p align="left"><b>出発日 : ${product.depday }</b></p></td>	 						
	 								</tr>	 								
									</table>
									</div>
									<div class="box-bottom">
									<a href="./ProductServlet?command=product_view&mainproduct_no=${product.mainproduct_no }">商品見る</a>
									</div>
								</div>
							</div>
						</c:forEach>		
