		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">旅行商品購買完了</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row demobtn">
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12">
						<h2>Thank you for using TOBYTOUR!</h2>
					</div>
				</div>
				<!-- divider -->
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-12">					
						<form action="../mypage/MainServlet?command=mypage_form" method="post">
						<table align="center">
							<tr>
								<td colspan="2"><p align="center">製品購買が完了しました。</p>
								<p align="center">24時間以内当社のｽﾀｯﾌがお客様に航空発券や旅行者確認のために</p>
								<p align="center">登録した連絡先に連絡いたします。</p>
								<p align="center">詳しく予約項目はﾏｲﾍﾟｰｼﾞで確認することができって</p>
								<p align="center">その他の問い合わせ事項があればﾏｲﾍﾟｰｼﾞ > 1対1 お問い合わせまたはお客様ｾﾝﾀｰ二語連絡ください。</p>
								<p align="center">TOBYTOURを利用してくださってありがとうございます。</p>
								</td>
							</tr>
							<tr>
								<td colspan="2"><p align="center"><input type="submit" class="btn btn-theme" value="ﾏｲﾍﾟｰｼﾞ"/></p></td>
							</tr>
						</table></form><br/><br/><br />							
