...
<!-- start header -->
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="../temp/img/slides/1.jpg" alt="" />
                <div class="flex-caption">
                    <h3>JR PASS RAILTOUR</h3> 
					<p>JR PASSで立つ列車旅行、TOBYTOURとともにしてください!</p> 
                </div>
              </li>
              <li>
                <img src="../temp/img/slides/2.jpg" alt="" />
                <div class="flex-caption">
                    <h3>JAPAN ROADTOUR</h3> 
					<p>時間関係なく自由にﾄﾞﾆｲﾋﾞﾝｸﾞﾂｱｰを行きたいならTOBYTOURで予約してください!</p> 
                </div>
              </li>
              <li>
                <img src="../temp/img/slides/3.jpg" alt="" />
                <div class="flex-caption">
                    <h3>ｵｰｽﾄﾗﾘｱの美しい景色</h3> 
					<p>自然と一つになる準備ができますか?　都市を離れTOBYTOURとともに自然に出かけましょう!</p>
                </div>
              </li>
            </ul>
        </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="cta-text">
						<h2><span>TOBYTOUR New Arrival Travel Product</span></h2>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row">
					...
					<div class="icon">
						<p align="center"><img src="${productListFilePath}${product.mainProductImage }" width="200" height="120"/></p>
					</div>
					<table border="0" align="center">
						<tr>
							<td id="line"><p align="left"><b>商品名 : ${product.mainProductName}</b></p></td>
	 					</tr>
	 					<tr>
	 						<td  id="line"><p align="left"><b>商品説明 : ${product.mainProductStatement }</b></p></td> 						
	 					</tr>
	 					<tr>
	 						<td  id="line"><p align="left"><b>出発日 : ${product.mainProductDepday }</b></p></td>	 						
	 					</tr>	 								
					</table>
					</div>
					<div class="box-bottom">
						<a href="../product/ProductServlet?command=product_view&mainproduct_no=${product.mainProductNo }">商品見る</a>
					</div>
					</div>
				</div>
				</c:forEach>		
