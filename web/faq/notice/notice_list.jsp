		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">公知事項</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-12">
				...
				<div class="col-lg-12">
					<table border="0" align="center" width="80%">
							<tr>
								<th width="10%" id="bline"><h4><p align="center">登録番号</p></h4></th>
            					<th width="40%" id="bline"><h4><p align="center">ﾀｲﾄﾒ</p></h4></th>
            					<th width="20%" id="bline"><h4><p align="center">作成日</p></h4></th>
            					<th width="10%" id="bline"><h4><p align="center">ｸﾘｯｸ数</p></h4></th>
							</tr>
							<c:forEach var="notice" items="${noticeList}">
							<tr class="record">
								<td width="10%" id="bline"><h5><p align="center">${notice.noticeSeq }</p></h5></td>
								<td width="40%" id="bline"><h5><p align="left"><a href="./WebNoticeServlet?command=notice_view&seq=${notice.noticeSeq}">${notice.noticeTitle }</a></p></h5></td>
								<td width="20%" id="bline"><h5><p align="center"><fmt:formatDate value="${notice.noticeDate }"/></p></h5></td>
								<td width="10%" id="bline"><h5><p align="center">${notice.noticeCount }</p></h5></td>
							</tr>
							</c:forEach>	
						   <tr>
						   		<td colspan="4" ><br/></td>
						   ...
						   <tr>
									...
									<c:if test="${count > 0}">
     								 ...
     								 <c:if test="${endPage > pageCount}" >
   									...
   									<c:if test="${numPageGroup > 1}">
       									<a href="./WebNoticeServlet?command=notice_list&page=${(numPageGroup-2)*pageGroupSize+1 }" class="btn theme">[移転]</a>
  									</c:if>
   									<c:forEach var="i" begin="${startPage}" end="${endPage}">
      									<a href="./WebNoticeServlet?command=notice_list&page=${i}" class="btn theme">[        						
  					 		...
  					 		<c:if test="${numPageGroup < pageGroupCount}">
        						<li><a href="./WebNoticeServlet?command=notice_list&page=${numPageGroup*pageGroupSize+1}" class="btn theme">[次]</a></li>
   							</c:if>
							</c:if>
							</td>
						</tr>
