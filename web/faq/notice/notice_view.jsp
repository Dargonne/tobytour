		...
		<div class="row demobtn">
			<div class="col-lg-12">
				...
				<table border="0" align="center" width="80%">
    				<tr>
      					<th width="20%" id="bline"><h4><p align="right">字番号 :</p></h4></th>
        				<td width="60%" id="bline"><h4><p align="left">&nbsp;&nbsp;${noticeArticle.noticeSeq}</p></h4></td>
    				</tr>
    				<tr>
        				<th width="20%" id="bline"><h4><p align="right">字ﾀｲﾄﾙ : </p></h4></th>
        				<td width="60%" id="bline"><h4><p align="left">&nbsp;&nbsp;${noticeArticle.noticeTitle}</p></h4></td>
    				</tr>
    				<tr>
        				<th width="20%" id="bline"><h4><p align="right">登録日 : </p></h4></th>
        				<td width="60%" id="bline"><h4><p align="left">&nbsp;&nbsp;${noticeArticle.noticeDate}</p></h4></td>
    				</tr>
    				<tr>
        				<th width="20%" id="bline"><h4><p align="right">ｸﾘｯｸ数 : </p></h4></th>
        				<td width="60%" id="bline"><h4><p align="left">&nbsp;&nbsp;${noticeArticle.noticeCount}</p></h4></td>
    				</tr>    
     				<tr>
          				<th width="20%" id="bline"><h4><p align="right">内容 : </p></h4></th>
          				<td width="60%" id="bline"><h4><p align="left">&nbsp;&nbsp;${noticeArticle.noticeContent}</p></h4></td>
    				</tr>
    				<tr>
         				<td colspan="2"><br/><br/></td>
    				</tr>
    				<tr>
         				<td colspan="2"><p align="center"><a href="./notice" class="btn btn-theme" >ﾘｽﾄ</a></p></td>
   					</tr>       
   					<tr>
   						<td colspan="2"><br/></td>
   					</tr>   
