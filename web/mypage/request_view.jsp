				...
				<div class="row">
					<div class="col-lg-12">
						<table border="0" align="center" width="90%">
							 <tr>
          						<th colspan="2" align="left"><h3>お問い合わせ事項の内容</h3></th>
      						 </tr>
       						<tr>
          						<th width="20%" id="bline"><h4><p align="right">お問い合わせ番号 : </p></h4></th>
		  						<td width="70%" id="bline"><h4><p align="left">&nbsp;&nbsp;${request.requestSeq }</p></h4></td>
      						 </tr>
      						 <tr>
       	  						<th id="bline"><h4><p align="right">お問い合わせ分類 : </p></h4></th>
       	  						<td id="bline"><h4><p align="left">&nbsp;&nbsp;${request.requestSection }</p></h4></td>
       						  </tr>
       						  <tr>
          						 <th id="bline"><h4><p align="right">文ﾀｲﾄﾙ : </p></h4></th>
         						 <td id="bline"><h4><p align="left">&nbsp;&nbsp;${request.requestTitle}</p></h4></td>
      						   </tr>
       						   <tr>
         						 <th id="bline"><h4><p align="right">お問い合わせ登録日 : </p></h4></th>
         						 <td id="bline"><h4><p align="left">&nbsp;&nbsp;${request.requestWriteDate }</p></h4></td>
      							</tr>
       							<tr>
           						 <th colspan="2" id="bline"><h4><p align="center">顧客の問い合わせ内容</p></h4></th>
      							</tr>
      							<tr>
          						 <td colspan="2" bgcolor="#EAEAEA" id="bline"><h5>${request.requestContent}</h5></td>
       							</tr>
       							<tr>
       	 						   <th colspan="2" id="bline"><h4><p align="center">答弁者答弁有無</p></h4></th>
      							</tr>
       							<c:if test="${request.requestReplyStatus == 0}">
								<tr>
									<td id="bline" colspan="2" bgcolor="#EAEAEA"><h5><p align="center">まだ担当者に返答が登録されませんでした。</p></h5></td>
								</tr>
								</c:if>
								<c:if test="${request.requestReplyStatus == 1}">
								<tr>
		 							<td id="bline" colspan="2" bgcolor="#EAEAEA"><h5>${request.requestReplyContent}</h5></td>
		 						</tr>
								<tr>
		 							<td id="bline"><h4><p align="center">答弁日 : </p></h4></td>
		 							<td id="bline"><h4>${request.requestReplyDate }</h4></td> 
		 						</tr>	    	  
								</c:if>
								<tr>
								...
								<tr>
									...
									<a href="./WebRequestServlet?command=request_delete_action&seq=${request.requestSeq}" class="btn btn-medium btn-theme" >削除</a>
									<a href="./WebRequestServlet?command=request_list" class="btn btn-medium btn-theme" >ﾘｽﾄ</a>
									<a href="./WebRequestServlet?command=request_write_form" class="btn btn-medium btn-theme" >新しい問い合わせ登録</a>
									</td>
								</tr>
						</table>
					</div>
