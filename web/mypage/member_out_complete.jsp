		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">会員脱退完了</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
				...
				<div class="pricing-box-alt">
					<div class="pricing-content">
						<table border="0" align="center">
							...
							<tr>
								<td><p align="align"><h5>会員脱退が完了しました。</h5></p></td>
							</tr>
							<tr>
								<td><p align="align"><h5>これまでTOBYTOURを利用してくださってありがとうございます。</h5></p></td>
							</tr>
							<tr>
								<td><p align="align"><a href="../main/WebMainServlet?command=main_page" class="btn btn-medium btn-theme" >ﾒｲﾝ画面移動</a></p></td>
							</tr>
