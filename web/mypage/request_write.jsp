...
<!-- start header -->
	...
	<section id="content">
	<form name="frm" action="./WebRequestServlet" >
	<input type="hidden" name="command" value="request_write_action" />
	<input type="hidden" name="id" value="${getUserInfo.requestID }" />
	<input type="hidden" name="name" value="${getUserInfo.requestUserName }" />
	<div class="container">
			...
			<div class="col-lg-12">
				...
				<div class="col-lg-12">
						<table border="0" align="center" width="90%">
							<tr>
            					<th width="20%" align="right"><h5><p align="right">問い合わせ区分 : </p></h5></th>
            					<td width="70%" align="left">&nbsp;
            						<select name="requestSection">
            							<option value="国内旅行">国内旅行</option>
            							<option value="海外旅行">海外旅行</option>
            						</select>
            					</td>
           					 </tr>
            				<tr>
            					<th><h5><p align="right">名前  : </p></h5></th>
            					<td><h5><p align="left">&nbsp;&nbsp;${getUserInfo.requestUserName }</p></h5></td>
          					</tr>
            				<tr>
            					<th><h5><p align="right">ﾒｰﾙ : </p></h5></th>
            					<td><p align="left">&nbsp;&nbsp;<input type="text" name="email" size="51" value="${getUserInfo.requestID }"/></p></td>
            				</tr>
            				<tr>
            					<th><h5><p align="right">連絡先 : </p></h5></th>
            					<td><p align="left">&nbsp;&nbsp;<input type="text" name="phone" size="51" value="${getUserInfo.requestPhone }" /></p></td>
           					</tr>
            				<tr>
            					<th><h5><p align="right">ﾀｲﾄﾙ : </p></h5></th>
            					<td><p align="left">&nbsp;&nbsp;<input type="text" name="title" size="51" /></p></td>
            				</tr>
           					 <tr>
            					<th rowspan="2" width="20%"><p align="right">問い合わせ内容 : </p></th>
            				</tr>
           					 <tr>
            					<td><p>&nbsp;&nbsp;<textarea name="content" rows="15" cols="50"></textarea></p></td>
           					</tr>
           					<tr>
           						<td><br/></td>
           					</tr>
           					<tr>
           						...
           						<input type="submit" class="btn btn-medium btn-theme" value="登録する" />&nbsp;&nbsp; 
								<input type="button" onclick="location.href='./WebRequestServlet?command=request_list'" class="btn btn-medium btn-theme" value="キャンセル" />
           						</td>
           					</tr>
						</table>
			</div><br/><br/>
