		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">会員情報修正</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row demobtn">
			<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-6">
					<form name="frm" action="./ModifyServlet?command=modify_update&id=${id }" method="post">
						<table align="center">
							<tr>
								<td colspan="2" align="center"><h4>基本情報変更</h4></td>
							</tr>
							<tr>
								<td align="right"><p>ID : </p></td>
							    <td><p>&nbsp;${id }</p></td>
							</tr>
							<tr>
								<td align="right"><p>名前 : </p></td>
							    <td><p>&nbsp;${name }</p></td>
							</tr>
							<tr>
								<td align="right"><p>生年月日 / 性別 : </p></td>
							    <td><p>&nbsp;${birth }/${sex }</p></td>
							</tr>	
							<tr>
								<td align="right"><p>住所 : </p></td>
							    <td><p>&nbsp;<input type="text" name="address" value="${address }" size="30"></p></td>
							</tr>	
							<tr>
								<td align="right"><p>連絡先 : </p></td>
							    <td><p>&nbsp;<input type="text" name="phone" value="${phone }" size="30"></p></td>
							</tr>	
							<tr>
								<td align="right"><p>ﾒｰﾙ受信するかどうか : </p></td>
								<td>&nbsp;<input type="radio" name="emailrecieve" value="1">&nbsp;&nbsp;はい&nbsp;&nbsp;&nbsp;&nbsp;
								 <input type="radio" name="emailrecieve" value="0">&nbsp;&nbsp;いいえ</td>
							</tr>
							<tr>
								<td colspan="2" align="center">
								<input type="submit" class="btn btn-medium btn-theme" value="保存する" onclick="return modify_check()">&nbsp;&nbsp;
								 <input type="reset" class="btn btn-medium btn-theme" value="もう一度書く"></td>
							</tr>
						</table><br/><br/><br />		
						</form>					
					</div>
					<div class="col-lg-6">
					<form name="frm2" action="./ModifyServlet?command=modify_update_pass&id=${id }" method="post">
						<table align="center">
							<tr>
								<td colspan="2" align="center"><h4>ﾊﾟｽﾜｰﾄﾞ変更</h4></td>
							</tr>
							<tr>
								<td align="right"><p>新しいﾊﾟｽﾜｰﾄﾞ : </p></td>
							    <td><p>&nbsp;<input type="password" name="pass" size="30"></p></td>
							</tr>
							<tr>
								<td align="right"><p>ﾊﾟｽﾜｰﾄﾟ再入力 : </p></td>
							    <td><p>&nbsp;<input type="password" name="pass2" size="30"></p></td>
							</tr>
							<tr>
								<td align="center" colspan="2"><p><input type="submit" class="btn btn-medium btn-theme" value="ﾊﾟｽﾜｰﾄﾞ変更" onclick="return pass_check()"></p></td>
							</tr>	
						</table><br/><br/><br />		
						</form>					
					</div>
