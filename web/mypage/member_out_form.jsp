		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">会員脱退</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row demobtn">
			<div class="col-lg-12">
				...
				<div class="pricing-box-alt">
					...
					<form name="frm" action="./MemberOutServlet" method="post">
						<input type="hidden" name="command" value="member_out_action" />
						<table border="0" align="center">
							<tr>
								<th colspan="2" align="center"><br/>※ 会員脱退を進行するためにはﾊﾟｽﾜｰﾄﾞを入力した後確認ﾎﾞﾀﾝを押してください。<br/>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;会員脱退をしたら登録された情報が全て削除されます。<br/><br/></th>
							</tr>
							<tr>
							...
							<tr>
								<td><p align="right">PW 入力 : </p></td>
								<td><p align="left">&nbsp;<input type="password" placeholder="パスワードを入力してください。" name="password" size="30" /></p></td>
							</tr>
							<tr>
								<td colspan="2">&nbsp;&nbsp;</td>
							</tr>
					...
					<div class="pricing-action">
						<input type="submit" class="btn btn-medium btn-theme" value="会員脱退する。" />&nbsp;&nbsp;<input type="button" class="btn btn-medium btn-theme" onclick="location.href='../mypage/MainServlet?command=mypage_form'" value="キャンセル" />
					</div>
				</div>
			</div>
			</form>
