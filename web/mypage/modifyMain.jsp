		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">情報修正</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row demobtn">
			<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12">
					<form action="./ModifyServlet?command=modify_check&id=${id }" method="post">
						<table align="center">
							<tr>
								<td colspan="2"><p align="center">本人確認のためﾊﾟｽﾜｰﾄﾞを<br/>もう一度入力してください。</p></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><p align="left">&nbsp;<input type="password" name="pass" size="30" /></p></td>
							</tr>
							<tr>
								<td colspan="2" align="center">
								<input type="submit" class="btn btn-medium btn-theme"  value="進入する" />&nbsp;&nbsp;
								<input type="button" class="btn btn-medium btn-theme"  onclick="location.href='../main/WebMainServlet?command=main_page'" value="キャンセル" />
								</td>
							</tr>
						</table><br/><br/><br />		
						</form>					
