	...
	<div class="container">
		<div class="row demobtn">
			<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12">
						<form name="frm" action="./LoginServlet?command=login_submit" method="post">
						<table align="center">
							<tr>
								<td colspan="2" align="center"><p>ｻｰﾋﾞｽを利用するためにはﾛｸﾞｲﾝしてください。</p></td>
							</tr>
							<tr>
								<td><p align="right">ID : </p></td>
								<td><p>&nbsp;&nbsp;<input type="text" name="id" size="30" placeholder="  ID@MAIL.COM"></p></td>
							</tr>
							<tr>
								<td><p align="right">PASS : </p></td>
								<td><p>&nbsp;&nbsp;<input type="password" name="pass" size="30" placeholder="  Put in your password"></p></td>
							</tr>
							<tr>
								<td colspan="2" align="right"><p><input type="submit" class="btn btn-theme" value="Log-in" onclick="return check()"></p></td>
							</tr>
							<tr>
								<td colspan="2"><p>IDがなければ...&nbsp;<a href="../register/RegisterServlet?command=register_form">会員加入</a></p></td>
								
							</tr>
							<tr>
								<td colspan="2"><p>ID/PWを忘れしたら...<a href="./LoginServlet?command=searchForm">ID/PW 探し</a></p></td>
							</tr>
						</table><br/><br/><br />							
						</form>
					</div>
