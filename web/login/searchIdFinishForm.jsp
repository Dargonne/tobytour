	...
	<div class="container">
		<div class="row demobtn">
			<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12">					
						<form action="LoginServlet?command=login_form" method="post">
						<table align="center">
							<tr>
								<td colspan="2">
								<p align="left"><h4>ID 探し結果</h4></p>
								<p align="center">お客様の IDは ${search_id }です。このIDでﾛｸﾞｲﾝしますか?</p></td>
							</tr>
							<tr>
								<td colspan="2"><p align="center"><input type="submit" class="btn btn-theme" value="Log-in"/></p></td>
							</tr>
						</table><br/><br/>
						</form>						
						<form action="../login/LoginServlet?command=searchForm" method="post">
						<table align="center">
							<tr>
								<td colspan="2"><p align="center">ﾊﾟｽﾜｰﾄﾞが思い出せなければﾊﾟｽﾜｰﾄﾞ探しを利用してください。</p></td>
							</tr>
							<tr>
								<td colspan="2"><p align="center"><input type="submit" class="btn btn-theme" value="PASSWORD 探し"/></p></td>
							</tr>
						</table></form><br/><br/><br />							
