		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">ID & PASSWORD 探し</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row demobtn">
			<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-6">
						<form name="frm" action="LoginServlet?command=search_id" method="post">
						<table align="center">
							<tr>
								<td colspan="2">
								<p align="left"><h3>ID 探し</h3></p>
								<p align="center">IDを探せば次の情報を入力してください</p></td>
							</tr>
							<tr>
								<td><p align="right">名前 : </p></td>
								<td><p>&nbsp;&nbsp;<input type="text" name="name" placeholder="ex)小田切譲" size="30" /></p></td>
							</tr>
							<tr>
								<td><p align="right">連絡先 : </p></td>
								<td><p>&nbsp;&nbsp;<input type="text" name="phone" placeholder="ex)07012345678" size="30"/></p></td>
							</tr>
							<tr>
								<td><p align="right">生年月日 : </p></td>
								<td><p>&nbsp;&nbsp;<input type="text" placeholder="ex)1990年 12月 30日 - 19901230"  name="birth" size="30"/></p></td>
							</tr>
							<tr>
								<td colspan="2"><p align="right"><input type="submit" class="btn btn-theme" value="ID 探し" onclick="return check_search_id()"></p></td>
					...
					<div class="col-lg-6">
						<form name="frm2" action="LoginServlet?command=search_pass" method="post">
						<table align="center">
							<tr>
								<td colspan="2">
								<p align="left"><h3>PASSWORD 探し</h3></p>
								<p align="center">PASSWORDを探せば次の情報を入力してください。</p></td>
							</tr>
							<tr>
								<td><p align="right">ID : </p></td>
								<td><p>&nbsp;&nbsp;<input type="text" name="id" placeholder="ex)ID@yourmail.com" size="30" /></p></td>
							</tr>
							<tr>
								<td><p align="right">連絡先 : </p></td>
								<td><p>&nbsp;&nbsp;<input type="text" name="phone" placeholder="ex)07012345678" size="30"/></p></td>
							...
							<tr>
								<td colspan="2"><p align="right"><input type="submit" class="btn btn-theme" value="PASSWORD 探し" onclick="return check_search_pass()"></p></td>
