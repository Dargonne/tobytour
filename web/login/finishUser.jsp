		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">ﾛｸﾞｲﾝ</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-12">
				...
				<div class="col-lg-12">
						<table border="0" align="center">							
							<tr>
								<td><center><b>${id }様歓迎致します。<br/>今日もTOBYTOURとよい一日をすごしてください。</b></center></td>							
							</tr>
							<tr>
								<td><br/><center><input type="button" class="btn btn-theme" onclick="location.href='../main/WebMainServlet?command=main_page'" value="利用する"/></center>
							</tr>
						</table>
				</div><br/><br/>
				<!-- divider -->
