        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td><input type="text" class="form-control" placeholder="タイトルを入力してください" name="title" size="84" maxlength="100" /></td>
            </tr>
            </thead>
            <tbody>
            <tr>
            	<th align="center">内容</th>
            	<td colspan="2"><textarea class="form-control" placeholder="内容を入力してください" cols="80" rows="10" name="content"></textarea></td>
            </tr>
			<tr>
				<td colspan="2" align="center"><input type="submit" class="btn btn-default" placeholder="内容を確認して登録してください"" value="登録"  onclick="return boardWriteCheck()"/>
				<input type="reset"  placeholder="すべての内容を削除します" class="btn btn-default" value="再構築" />
				<input type="button" placeholder="作成をキャンセルして、リストに移動します" class="btn btn-default" value="リスト" onclick="location.href='./notice'" />
				</td>
			</tr>
            </tbody>
          </table>
