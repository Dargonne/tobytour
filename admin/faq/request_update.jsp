  ...
  <div class="content-wrapper">
	...
	<br/>
      <ol class="breadcrumb">
        ...
        <li class="active">一対一のお問い合わせ管理</li>
      </ol>
    </section>

    <!-- Main content -->
    <section class="invoice">
	<form name="frm" method="post" action="./RequestServlet">
	<input type="hidden" name="command" value="request_update" />
	<input type="hidden" name="seq" value="${requestUpdate.requestSeq }" />
      <!-- title row -->
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> 一対一のお問い合わせ管理
          </h2>
        </div>
        <!-- /.col -->
      </div>
          ...
          <table class="table table-striped">
            <thead>
            	<div class="callout callout-info">
        			<h4>注意!</h4>
       				一度回答した登録は変更または削除することができないので、答えの際はご注意下さい。       
      			</div>
            </thead>
            <tbody>
            <tr>
            	<th>お問い合わせ番号 : </th>
            	<td>${requestUpdate.requestSeq }</td>
            </tr>
            <tr>
            	<th>お問い合わせ区分 : </th>
            	<td>${requestUpdate.requestSection }</td>
            </tr>
            <tr>
            	<th>ID : </th>
            	<td>${requestUpdate.requestID }</td>
            </tr>
            <tr>
            	<th>タイトル </th>
            	<td>${requestUpdate.requestTitle }</td>
            </tr>
            <tr>
            	<th>作成日 </th>
            	<td>${requestUpdate.requestWriteDate }</td>
            </tr>
            <tr>
            	<th colspan="2">お問い合わせの内容</th>
            </tr>
            <tr>
            	<td colspan="2">${requestUpdate.requestContent }</td>
            </tr>
            <tr>
            	<th colspan="2">担当者の回答項目</th>
            </tr>
            <tr>
            	<c:if test="${requestUpdate.requestReply == 0}">
								<tr>
									<th colspan="2">担当者の回答する</th>
								<tr>
								<tr>
									<td colspan="2"><textarea class="form-control" placeholder="内容を入力してください" cols="80" rows="10" name="content">
									</textarea></td>
								</tr>
								<tr>
									<td colspan="2" align="center">
									<input type="submit" class="btn btn-default"  value="回答の登録"  />
									<input type="reset"  class="btn btn-default"  value="回答新たに送る" />
									<input type="button" class="btn btn-default"  value="文リスト" onclick="location.href='./request'" />
									
								</tr>
  					</c:if>
  					<c:if test="${requestUpdate.requestReply == 1}">
  								<tr>
									<th colspan="2">担当者の回答内容</th>
								<tr>
								<tr>
									<td colspan="2"> ${requestUpdate.requestReplyContent}</td>
								</tr>
       							<tr>
									<td colspan="2" align="center">
										<input type="button" value="文リスト"  class="btn btn-default"  onclick="location.href='./request'" />
								</tr>
