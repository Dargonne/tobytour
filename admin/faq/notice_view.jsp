      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            <thead>
            <tr>
              <th colspan="2"><h3>お知らせの内容</h3></th>
            </tr>
            </thead>
            <tbody>
            <tr>
              <th>文の番語</th>
              <td>${noticeArticle.noticeSeq}</td>
            </tr>
            <tr>
              <th>文のタイトル</th>
              <td>${noticeArticle.noticeTitle}</td>
            </tr>
            <tr>
              <th>登録の日</th>
              <td>${noticeArticle.noticeWriteDate}</td>
            </tr>
            <tr>
              <th colspan="2">内容</th>
            </tr>
            <tr>
              <td colspan="2">${noticeArticle.noticeContent}</td>
            </tr>
            <tr>
              <td colspan="2">
                   	<div class="box-footer clearfix">
					<ul class="pagination pagination-sm no-margin pull-right">
						<li><a href="./NoticeServlet?command=notice_update_form&seq=${noticeArticle.noticeSeq}">修正</a></li>
						<li><a href="./NoticeServlet?command=notice_delete&seq=${noticeArticle.noticeSeq}">削除</a></li>
						<li><a href="./notice">リスト</a></li>
						<li><a href="./NoticeServlet?command=notice_write_form">新しいおしらせの登録</a></li>
						</ul>
				</div>
              </td>
            </tr>
