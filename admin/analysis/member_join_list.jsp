...
<input type="hidden" name="joinDate3" value="${joinDate3 }" />
<input type="hidden" name="joinDate4" value="${joinDate4 }" />
<input type="hidden" name="joinDate5" value="${joinDate5 }" />
<input type="hidden" name="joinDate6" value="${joinDate6 }" />
<input type="hidden" name="joinDate7" value="${joinDate7 }" />
<input type="hidden" name="joinCount1" value="${joinCount1 }" />
<input type="hidden" name="joinCount2" value="${joinCount2 }" />
<input type="hidden" name="joinCount3" value="${joinCount3 }" />
<input type="hidden" name="joinCount4" value="${joinCount4 }" />
<input type="hidden" name="joinCount5" value="${joinCount5 }" />
<input type="hidden" name="joinCount6" value="${joinCount6 }" />
<input type="hidden" name="joinCount7" value="${joinCount7 }" />
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
			...
			<script>		
				 var joinDate1 = document.frm.joinDate1.value; 
				 var joinDate2 = document.frm.joinDate2.value;
				 var joinDate3 = document.frm.joinDate3.value;
				 var joinDate4 = document.frm.joinDate4.value;
				 var joinDate5 = document.frm.joinDate5.value;
				 var joinDate6 = document.frm.joinDate6.value;
				 var joinDate7 = document.frm.joinDate7.value;
				 var joinCount1 = document.frm.joinCount1.value; 
				 var joinCount2 = document.frm.joinCount2.value; 
				 var joinCount3 = document.frm.joinCount3.value; 
				 var joinCount4 = document.frm.joinCount4.value; 
				 var joinCount5 = document.frm.joinCount5.value; 
				 var joinCount6 = document.frm.joinCount6.value; 
				 var joinCount7 = document.frm.joinCount7.value;
                 var container = document.getElementById('chart-area'),
     			   data = {
         			   categories: [joinDate1,joinDate2,joinDate3,joinDate4,joinDate5, joinDate6, joinDate7],
          			series: [
            	    {
                	    name: '加入者数',
               		     data: [joinCount1, joinCount2, joinCount3, joinCount4, joinCount5, joinCount6, joinCount7]
               		 },
          			  ]
      				  },
       				 options = {
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
            <tr>
               <c:forEach var="count" items="${memberJoinAllList }">
					<tr class="record">
						<td><fmt:formatDate value="${count.newMemberJoinDate }"/></td>
						<td>${count.newMemberJoinCount }</td>
					</tr>
					</c:forEach>
				<tr>				
						...
						<c:if test="${count > 0}">
     					 ...
     					 <c:if test="${endPage > pageCount}" >
   						...
   						<c:if test="${numPageGroup > 1}">						
       						 <li><a href="./AnalysisServlet?command=analysis_new_member&page=${(numPageGroup-2)*pageGroupSize+1 }">[前]</a></li>
  						</c:if>
	   					<c:forEach var="i" begin="${startPage}" end="${endPage}">
    	  					 <li><a href="./AnalysisServlet?command=analysis_new_member&page=${i}">[						
	  					 ...
	  					 <c:if test="${numPageGroup < pageGroupCount}">
    	    				<li><a href="./AnalysisServlet?command=analysis_new_member&page=${numPageGroup*pageGroupSize+1}">[次]</a></li>
   						</c:if>
   						</ul>
   					</div>
					</c:if>
