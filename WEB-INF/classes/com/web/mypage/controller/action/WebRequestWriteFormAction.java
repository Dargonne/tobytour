...
public class WebRequestWriteFormAction implements WebRequestAction {

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		String url = "/web/mypage/request_write.jsp"; 
		...
		// 글번호에 해당하는 내용을 상세보기
		WebRequestDTO dto = dao.getUserInfo(userID);
		request.setAttribute("getUserInfo", dto);
