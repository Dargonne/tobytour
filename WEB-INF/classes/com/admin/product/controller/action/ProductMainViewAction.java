...
import com.admin.dao.OrderListDAO;
import com.admin.dao.ProductMainViewDAO;
import com.admin.dto.OrderListDTO;
import com.admin.dto.ProductMainViewDTO;

public class ProductMainViewAction implements ProductAction{

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		
		String url = "/admin/product/product_main_view.jsp"; 
		...
		String productFilePath = "../../temp/img/product/" + dto.getMainProductImage();
		String hotelFilePath = "../../temp/img/hotel/" + dto.getMainHotelImage();		
	
		if(dto.getMainProductImage() == null)
		{
			productFilePath = "../../temp/img/noimage.jpg"; 
		}
		
		if(dto.getMainHotelImage() == null)
		{
			hotelFilePath = "../../temp/img/noimage.jpg";
		}
	   ...
	   // ArrayList articleList = new ArrayList(); // Paging 처리를 위한 ArrayList
		List<ProductMainViewDTO> subProductList = new ArrayList(); 

		count = dao.getSubProductTotal(seqNumber); //전체 글의 수

		 if (count > 0) {        
			 if(endRow>count)
				 endRow = count;
			 		subProductList = dao.showChoiceProductInfo(seqNumber, startRow, endRow);
		...
		request.setAttribute("seqNumber" , seqNumber);
